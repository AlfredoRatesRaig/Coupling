 ...
 **/
#ifndef _FILTER2_DCDT_DEFINES_H
#define _FILTER2_DCDT_DEFINES_H
...
/**
  ...
  H(s) = Kdc X --- X ------------
                s    Wz1(Wp2 + s)
                  ...
                  1.57e+04   2.20e+05(1.00e+05 + s)
  H(s) = 1.000 X -------- X ----------------------
                     s       1.00e+05(2.20e+05 + s)
  ...
  b0      0.123     0.123         4043    0x0FCB
  b1      0.082     0.082         2695    0x0A87
  b2      -0.041    -0.041        -1347   0xFABD
...
#define FILTER2_COMP_2P2Z_COEFF_A1      0x79EE
#define FILTER2_COMP_2P2Z_COEFF_A2      0x0611
#define FILTER2_COMP_2P2Z_COEFF_B0      0x0FCB
#define FILTER2_COMP_2P2Z_COEFF_B1      0x0A87
#define FILTER2_COMP_2P2Z_COEFF_B2      0xFABD
#define FILTER2_COMP_2P2Z_POSTSCALER    0x7FFF
#define FILTER2_COMP_2P2Z_POSTSHIFT     0x0000
#define FILTER2_COMP_2P2Z_PRESHIFT      0x0000


/* Compensator Clamp Limits */
#define FILTER2_COMP_2P2Z_MIN_CLAMP    0x0000
#define FILTER2_COMP_2P2Z_MAX_CLAMP    0x7FFF
